  <div class=" sidebar" role="navigation">
        ...
        <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
          <ul class="nav" id="side-menu">
            ...
            <li>
              <a href="add-services.php"><i class="fa fa-wrench nav_icon"></i>Services<span class="fa arrow"></span> </a>
              ...
              <li>
              <a href="add-products.php"><i class="fa fa-shopping-cart nav_icon"></i>Products<span class="fa arrow"></span> </a>
              <ul class="nav nav-second-level collapse">
                <li>
            ...
            <!-- <li>
              <a href="Calendar.php" class="chart-nav"><i class="fa fa-calendar nav_icon"></i>Scheduling</a>
            </li> -->

        
           <li>
              <a href="readenq.php"><i class="fa fa-check-square-o nav_icon"></i>Customer Support<span class="fa arrow"></span></a>
              <ul class="nav nav-second-level collapse">
        ...
        <li><a href="unreadenq.php">Unread Enquiry</a></li>
             ...
             <li>
              ...
              <li>
              <a href="bwdates-reports-ds.php"><i class="fa fa-bar-chart nav_icon"></i>Reports<span class="fa arrow"></span></a>
              <ul class="nav nav-second-level collapse">
