...
move_uploaded_file($_FILES["image"]["tmp_name"],"images/".$newimage);
 ...
 $eid=$_GET['lid'];
    ...
    $query=mysqli_query($con, "update  tblproducts set Image='$newimage' where ID='$eid' ");
    if ($query) {
...
?> 
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1">Product Name</label> <input type="text" class="form-control" id="proname" name="proname" placeholder="Product Name" value="<?php  echo $row['ProductName'];?>" readonly="true"> </div>
