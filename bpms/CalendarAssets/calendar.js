document.addEventListener('DOMContentLoaded', function() {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        events: url+'CalendarAssets/api/load.php',
        eventDrop: function(arg) {
            ...
            $.ajax({
              url:url+"CalendarAssets/api/update.php",
              type:"POST",
        ...
        eventClick: function(arg) {
            ...
            $.ajax({
              url:url+"CalendarAssets/api/getevent.php",
              type:"POST",
              dataType: 'json',
              data:{id:id},
    ...
    $('#createEvent').submit(function(event) {
        ...
        $.ajax({
            type        : "POST",
            url         : url+'CalendarAssets/api/insert.php',
            data        : $(this).serialize(),
            dataType    : 'json',
            encode      : true
        }).done(function(data) {
