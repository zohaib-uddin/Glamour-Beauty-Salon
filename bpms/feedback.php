...
<html lang="en">
  <head>
    ...
    <title>Salon Management System | Feedback Page</title>
...
<section class="w3l-inner-banner-main">
 ...
 Feedback
            ...
            <p class="tiltle-para">Share your feedback to help us improve and serve you better!
            </p>
        </div>
</div>
</div>
...
?>
                    <div class="cont-top">
                        ...
                        <div class="cont-right">
                            <h6>Call Us</h6>
                            <p class="para"><a href="tel:+92 3232806257">+<?php  echo $row['MobileNumber'];?></a></p>
                        </div>
                    </div>
                    <div class="cont-top margin-up">
                        ...
                        <div class="cont-right">
                            <h6>Email Us</h6>
                            <p class="para"><a href="mailto:zohaibuddin376@mail.com" class="mail"><?php  echo $row['Email'];?></a></p>
                        </div>
                    </div>
                    <div class="cont-top margin-up">
                        <div class="cont-left text-center">
